      ...
      <div className="mt-20 flex flex-col gap-8">
        ...
        {/* Toolbox */}
          ...
          <CardHeader title="My Toolbox" description="Explore the technologies and tools I use to craft digital experiences." className=""/>
            ...
            <ToolboxItems items={toolboxItems} className="mt-6 -translate-x-1/2" itemsWrapperClassname="-translate-x-1/2 animate-move-right animate-move-left [animation-duration:15s]"/>
          </Card>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 lg:grid-cols-3">
          ...
          <Card className="h-[320px] p-0 relative md:col-span-2 lg:col-span-1">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-20 rounded-full after:content-[''] after:absolute after:inset-0 after:rounded-full after:border-2 after:border-gray-950/30">
